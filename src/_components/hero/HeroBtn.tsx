...
function HeroBtn() {
  ...
  return (
    <Button
      ...
      pl={4}
      rad={32}
      bgColor="var(--heroBtnBg-color)"
      textColor="var(--heroBtnText-color)"
      fontSize={14}
      fontWeight={500}
      borderColor="var(--heroBtnBorder-color)"
    >
      {/* button content  */}
