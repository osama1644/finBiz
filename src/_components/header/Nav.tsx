...
function Nav() {
  ...
  const links: Links[] = [
    { lable: t("nav.product"), path: "/product" },
    { lable: t("nav.pages"), path: "#" },
    { lable: t("nav.integrations"), path: "/integrations" },
    { lable: t("nav.blog"), path: "/blog" },
    { lable: t("nav.pricing"), path: "/pricing" },
  ];
